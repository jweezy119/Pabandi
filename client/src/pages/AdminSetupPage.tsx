    ...
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden px-4" style={{ background: tokens.color.background }}>
      ...
      <div className="w-full max-w-md relative z-10">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold mt-4" style={{ color: tokens.color.text }}>Admin Setup</h1>
          <p className="text-sm mt-1" style={{ color: tokens.color.textMuted }}>Create the first administrator account</p>
        </div>
        ...
        <Surface className="p-6">
          {success ? (
            ...
            <div className="text-center">
              <div className="mb-4 rounded-xl border px-4 py-3 text-sm font-medium" style={{ background: 'rgba(251,191,36,0.12)', borderColor: 'rgba(251,191,36,0.25)', color: '#fbbf24' }}>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  <label htmlFor="firstName" className="mb-1.5 block text-xs font-semibold uppercase tracking-wide" style={{ color: tokens.color.textDim }}>First Name</label>
                  <input
                    id="firstName"
                    type="text"
                    required
                ...
                <div>
                  <label htmlFor="lastName" className="mb-1.5 block text-xs font-semibold uppercase tracking-wide" style={{ color: tokens.color.textDim }}>Last Name</label>
                  <input
                    id="lastName"
                    type="text"
                    required
              ...
              <div>
                <label htmlFor="password" className="mb-1.5 block text-xs font-semibold uppercase tracking-wide" style={{ color: tokens.color.textDim }}>Password</label>
                <input
                  id="password"
                  type="password"
                  required
