...
export const TrustPulsePage = () => {
  ...
  return (
    <div className="min-h-screen bg-[var(--warm-ink)] text-[var(--warm-ink)] p-4 md:p-8">
      <div className="max-w-lg mx-auto space-y-4">
        ...
        {user?.id ? (
          ...
          <div className="rounded-2xl border border-zinc-800 bg-[var(--cream)] p-4 text-xs text-zinc-400">
            Sign in to see your Live Trust Pulse.
          </div>
        )}

        <div className="rounded-2xl border border-zinc-800 bg-[var(--cream)] p-4 text-xs text-zinc-500">
