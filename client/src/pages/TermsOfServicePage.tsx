...
export default function TermsOfServicePage() {
  return (
    <div className="mx-auto max-w-5xl px-4 py-12 sm:px-6 md:px-8 space-y-6 sm:space-y-8 sm:space-y-12 sm:space-y-16 font-body" style={{ background: tokens.color.background, color: tokens.color.text }}>
      ...
      <section className="rounded-3xl border border-[rgba(191,179,163,0.15)] bg-[var(--warm-sand)] p-5 shadow-sm transition-all hover:-translate-y-[2px] hover:border-[rgba(191,179,163,0.2)] sm:p-8 md:p-10">
        <div className="flex h-14 w-14 items-center justify-center rounded-full border border-[var(--clay)]/20 bg-[var(--clay)]/10">
          <span className="text-2xl">📄</span>
        </div>
        <div>
          <h2 className="font-headline mb-2 text-2xl font-bold text-[var(--warm-ink)]">1. General Use, Privacy & Data Rights</h2>
      ...
      {/* Section 3: Web3 & SEC */}
      <section className="rounded-3xl border border-[var(--clay)]/20 bg-[var(--clay)]/5 p-5 shadow-sm transition-all hover:-translate-y-[2px] hover:border-[var(--clay)]/30 sm:p-8 md:p-10 relative overflow-hidden">
        <div className="pointer-events-none absolute right-0 top-0 h-32 w-32 rounded-full bg-[var(--clay)]/10 blur-2xl -translate-y-1/2 translate-x-1/2"></div>
        <div className="relative z-10 flex h-14 w-14 items-center justify-center rounded-full border border-[var(--clay)]/30 bg-[var(--clay)]/20">
          <span className="text-2xl">⚡</span>
        </div>
        <div className="relative z-10">
          <h2 className="font-headline mb-2 text-2xl font-bold text-[var(--warm-ink)]">3. Web3, $PAB Token & Financial Regulations</h2>
          <div className="space-y-6 font-body" style={{ color: tokens.color.textDim }}>
            <div>
              <h3 className="mb-2 font-bold text-[var(--warm-ink)]">
      ...
      <section className="rounded-3xl border border-[rgba(191,179,163,0.15)] bg-[var(--warm-sand)] p-5 shadow-sm transition-all hover:-translate-y-[2px] hover:border-[rgba(191,179,163,0.2)] sm:p-8 md:p-10">
        ...
        <div>
          <h2 className="font-headline mb-2 text-2xl font-bold text-[var(--warm-ink)]">4. Smart Contracts & On-Chain Finality</h2>
