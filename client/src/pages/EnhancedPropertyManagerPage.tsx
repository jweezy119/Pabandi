...
export const EnhancedPropertyManagerPage: React.FC = () => {
  ...
  const loadDashboard = async () => {
    try {
      ...
      aiInsights.push({
        ...
        description: `Your portfolio is performing well. NOI margin: ${financials ? Math.round((financials.noi / financials.totalIncome) * 100) : 60}%. DSCR: 1.35x.`,
        action: 'View Report',
      ...
      <div className="max-w-7xl mx-auto px-4 py-6">
        <div className="flex items-center justify-between mb-6">
          ...
          <div className="flex items-center gap-2">
            <Badge tone="success">{dash?.stats?.occupancyRate || 0}% Occupancy</Badge>
              ...
              <Surface className="p-4 md:p-6">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                  <div className="p-3 rounded-xl bg-white/5 text-center">
                    <div className="text-xl font-bold text-emerald-300">${(financials.totalIncome / 1000).toFixed(0)}K</div>
                    <div className="text-xs" style={{ color: tokens.color.muted }}>Annual Income</div>
                  </div>
                  <div className="p-3 rounded-xl bg-white/5 text-center">
                    <div className="text-xl font-bold text-rose-300">${(financials.totalExpenses / 1000).toFixed(0)}K</div>
                    <div className="text-xs" style={{ color: tokens.color.muted }}>Annual Expenses</div>
                  </div>
                  <div className="p-3 rounded-xl bg-white/5 text-center">
                    <div className="text-xl font-bold text-indigo-300">${(financials.noi / 1000).toFixed(0)}K</div>
                    <div className="text-xs" style={{ color: tokens.color.muted }}>NOI</div>
                  </div>
                  <div className="p-3 rounded-xl bg-white/5 text-center">
                    <div className="text-xl font-bold text-amber-300">{financials.occupancyRate}%</div>
          ...
          <div className="space-y-4">
            <Surface className="p-4 md:p-6">
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
                <div className="p-3 rounded-xl bg-white/5 text-center">
                  <div className="text-lg font-bold text-emerald-300">${financials.avgRent}</div>
                  <div className="text-xs" style={{ color: tokens.color.muted }}>Avg Rent</div>
                </div>
                <div className="p-3 rounded-xl bg-white/5 text-center">
                  <div className="text-lg font-bold text-indigo-300">{financials.occupancyRate}%</div>
                  <div className="text-xs" style={{ color: tokens.color.muted }}>Occupancy</div>
                </div>
                <div className="p-3 rounded-xl bg-white/5 text-center">
                  <div className="text-lg font-bold text-amber-300">{financials.latePayments}</div>
                  <div className="text-xs" style={{ color: tokens.color.muted }}>Active Tenants</div>
                </div>
              </div>
            </Surface>
...
export default EnhancedPropertyManagerPage;
