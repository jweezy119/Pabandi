    ...
    <div className="min-h-screen" style={{ background: tokens.color.background }}>
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="flex items-center justify-between mb-8">
          <div>
            <h1 className="text-2xl md:text-3xl font-bold text-[var(--warm-ink)]">My Guest List</h1>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-8">
          {[
            ...
            <Surface key={stat.label} className="p-4 text-center">
              <span className={`material-symbols-outlined ${stat.label === 'Confirmed' ? 'text-[var(--sage)]' : stat.label === 'Pending' ? 'text-[var(--muted-ochre)]' : 'text-[var(--terracotta)]'}`}>{stat.icon}</span>
              <p className="text-xl font-bold text-[var(--warm-ink)] mt-1">{stat.value}</p>
                ...
                <div className="flex flex-col md:flex-row md:items-center gap-4">
                  <div className="flex-1">
                    <div className="flex items-center gap-3 mb-2">
                      <h3 className="text-[var(--warm-ink)] font-bold">{entry.venueName}</h3>
                  ...
                  <div className="mt-4 pt-4 border-t border-[var(--soft-stone)]/30">
                    <div className="flex flex-col sm:flex-row items-center gap-4">
                      ...
                      <div className="text-center sm:text-left">
                        ...
                        <div className="px-3 py-1.5 bg-[var(--cream)] rounded-lg inline-block">
                          <span className="text-xs font-mono text-[var(--terracotta)]">GL-{entry.id.padStart(6, '0')}</span>
                        </div>
