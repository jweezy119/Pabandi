...
// OAuth providers removed — buttons were misleading without working credentials
...
export default function AuthPage() {
  ...
  const [oauthLoading, setOauthLoading] = useState<'wallet' | null>(null);
  ...
  return (
    <div className="flex min-h-screen items-center justify-center relative overflow-hidden px-4 py-12" style={{ background: tokens.color.background }}>
      ...
      <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(rgba(0,0,0,0.25)_1px,transparent_1px)] [background-size:40px 40px]" />
