...
export default function DeveloperPortalPage() {
  ...
  const TIERS = [
  {
    ...
    cta: selectedTier === 'starter' ? 'Selected' : 'Get Started Free',
    popular: false,
  },
  {
    id: 'growth',
    ...
    cta: selectedTier === 'growth' ? 'Selected' : 'Buy Growth Tier',
    popular: true,
  },
  {
    id: 'enterprise',
    ...
    cta: selectedTier === 'enterprise' ? 'Selected' : 'Buy Enterprise',
    popular: false,
  },
];
  ...
  const runPlayground = async () => {
    ...
    setResponse(null);
    try {
      const res = await fetch(`${API_HOST}/external/v1/score`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        ...
        <div style={{
          ...
          {apiKeyGenerated ? (
            ...
            <>
              ...
              <p style={{ marginTop: '12px', color: '#475569', fontSize: '12px' }}>Powered by Safepay & Web3.</p>
            </>
          )}
        </div>
      </section>
