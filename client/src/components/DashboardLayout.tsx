...
export default function DashboardLayout({ osName, osIcon, osColor, navItems, children }: DashboardLayoutProps) {
  ...
  return (
    <div className="min-h-screen flex bg-[#020617]">
      ...
      {/* Sidebar */}
      <aside
        className={`fixed lg:static z-50 w-64 h-screen bg-[#0a0f1a] border-r border-white/5 flex flex-col transition-transform duration-300 ${
              ...
              return (
                <Link
                  ...
                  className={`flex-1 flex flex-col items-center justify-center gap-0.5 px-2 py-2 text-[11px] font-medium min-w-[64px] ${
                    active ? colors.activeText : 'text-slate-400 active:text-white'
                  }`}
                >
