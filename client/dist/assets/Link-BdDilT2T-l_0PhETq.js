import{dc as d,dd as c}from"./index-DMgB8B-w.js";let l=c.a`
  && {
...
`;const p=({size:r="md",variant:e="navigation",disabled:i=!1,as:a,children:t,onClick:o,...s})=>d.jsx(l,{as:a,$size:r,$variant:e,$disabled:i,onClick:n=>{i?n.preventDefault():o==null||o(n)},...s,children:t});export{p as i};
