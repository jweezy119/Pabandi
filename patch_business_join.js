const fs = require('fs');
const file = 'client/src/pages/BusinessJoinPage.tsx';
let content = fs.readFileSync(file, 'utf8');

// I will create a completely new file content that preserves the form component at the bottom but replaces the top landing page
            ...
            <div className="space-y-4">
              ...
              <div className="bg-white/5 p-4 rounded-2xl flex items-center justify-between">
                ...
                <div className="text-right">
                  ...
                  <div className="text-[10px] text-slate-400">₨500 dep.</div>
                </div>
              </div>
              ...
              <div className="bg-emerald-500/5 border border-emerald-500/20 p-4 rounded-2xl flex items-center justify-between relative overflow-hidden">
                ...
                <div className="text-right relative z-10">
                  ...
                  <div className="text-[10px] text-emerald-400 font-bold bg-emerald-500/20 px-1.5 py-0.5 rounded">₨1,500 dep.</div>
                </div>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-[#0f172a] border border-white/5 p-8 rounded-3xl hover:border-white/10 transition-colors">
              ...
              <p className="text-slate-400 text-sm leading-relaxed">High-risk bookings trigger automatic deposit requests via Safepay. Supports credit/debit cards, JazzCash, and EasyPaisa. Funds settle directly to your account.</p>
            </div>
            <div className="bg-[#0f172a] border border-white/5 p-8 rounded-3xl hover:border-white/10 transition-colors">
              <div className="text-4xl mb-6">📊</div>
            ...
            <div className="bg-[#0f172a] border border-white/5 p-8 rounded-3xl hover:border-white/10 transition-colors">
              <div className="text-4xl mb-6">🌐</div>
              <h3 className="text-xl font-bold text-white mb-3">Global & Local Compliance</h3>
              <p className="text-slate-400 text-sm leading-relaxed">PCI-DSS & PDPB compliant data handling. Stripe & Safepay local payment gateways. Multi-lingual support built for global scale.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-32 px-6">
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-20 items-center">
          <div>
            ...
            <h2 className="text-4xl md:text-5xl font-black text-white mb-6 leading-tight">Get paid in tokens,<br />not just rupees.</h2>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-gradient-to-b from-[#0f172a] to-[#080e17] rounded-3xl p-8 border border-blue-500 flex flex-col relative shadow-[0_0_50px_rgba(59,130,246,0.1)] scale-105 z-10">
              ...
              <div className="text-3xl font-black text-white mb-4">₨4,999 <span className="text-lg text-slate-500 font-normal">/ month</span></div>
