...
import aiAdvancedRoutes from './routes/aiAdvanced.routes';
import aiRealEstateRoutes from './routes/aiRealEstate.routes';
import aiRoutes from './routes/ai.routes';
import marketplaceRoutes from './routes/marketplace.routes';
import escrowRoutes from './routes/escrow.routes';
import notificationsRoutes from './routes/notifications.routes';
import walletAuthRoutes from './routes/walletAuth.routes';
...
app.use(`/api/v1/nightlife/integrations`, nightlifeIntegrationRoutes);
app.use(`/api/v1/agents`, agenticRoutes);
