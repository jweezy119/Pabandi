...
export class SafCarrierService {
...
export class SafMatchingService {
...
export const safLoad = new SafLoadService();
export const safCarrier = new SafCarrierService();
export const safMatching = new SafMatchingService();
export const safRate = new SafRateService();
