...
export class HaqRevenueService {
...
export class HaqMaintenanceService {
...
export class HaqCommunicationService {
...
export const haqRevenue = new HaqRevenueService();
export const haqTenant = new HaqTenantService();
export const haqLease = new HaqLeaseService();
export const haqMaintenance = new HaqMaintenanceService();
export const haqCommunication = new HaqCommunicationService();
