...
const bookingScraper_service_1 = require("../src/services/bookingScraper.service");
...
async function seedHotels() {
    ...
    for (const city of SEED_CITIES) {
        try {
            ...
            const searchResult = await bookingScraper_service_1.bookingScraperService.searchHotels({
                query: city.query,
                checkin: '2026-09-24',
                checkout: '2026-09-26',
                adults: 2,
