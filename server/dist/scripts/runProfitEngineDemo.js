...
const profitEngine_service_1 = require("../src/services/profitEngine.service");
...
async function runProfitDemo() {
    ...
    console.log('═══════════════════════════════════════════════════════\n');
    console.log(`   Fee Rate: ${(profitEngine_service_1.profitEngine.feeRate * 100).toFixed(2)}%`);
    console.log(`   Adjustments Made: ${profitEngine_service_1.profitEngine.cycleTimes?.length || 0}`);
