 ...
 */
const discoverAgents = async (req, res) => {
    try {
        ...
        logger_1.logger.info(`[Discovery] Received GB/Z 185.5 natural language query: "${query}"`);
        ...
        logger_1.logger.error('[Discovery] Error in natural language discovery:', error);
