...
exports.openwaTemplateService = exports.OpenWATemplateService = void 0;
...
class OpenWATemplateService {
     ...
     */
    async sendTemplate(toPhone, templateName, variables, options) {
        ...
        try {
            ...
            return await whatsapp_service_1.openwaService.sendTemplate(`${String(toPhone).replace(/[^\d]/g, '')}@c.us`, templateName, variables, options);
        }
        catch {
            // Fallback: send as plain text (OpenWA template may not be registered)
            logger_1.logger.debug(`[TemplateService] Native template "${templateName}" not available, sending as text`);
            return await whatsapp_service_1.openwaService.sendText(toPhone, rendered, options);
        }
    }
}
exports.OpenWATemplateService = OpenWATemplateService;
exports.openwaTemplateService = new OpenWATemplateService();
//# sourceMappingURL=openwa.template.service.js.map