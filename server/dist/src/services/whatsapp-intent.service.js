...
exports.whatsAppIntentService = exports.WhatsAppIntentService = void 0;
...
const DEFAULT_REPLIES = {
    cancel: "To cancel, reply *Cancel*.\nIf you have a deposit, it will be refunded automatically after cancellation.",
    reschedule: "To reschedule, please share your new preferred date and time, for example: *Reschedule to 24 Dec at 7pm*.",
    status: "You can view your booking details in the Pabandi app or website. If you want, I can message your latest status here.",
    book: "I can help with a booking. Please share:\n- Preferred date\n- Time\n- Number of guests\n- Occasion (optional)",
    hours: "Business hours vary by location. Please share the venue name and I can check the current schedule.",
    checkout: "You can pay safely via Pabandi escrow. Use the checkout link from your booking confirmation or share the booking ID.",
    faq: "Common questions: deposits, refunds, no-shows, parking, and dietary notes. Ask me any of these and I will help.",
};
class WhatsAppIntentService {
    ...
    pluginSummaryFor(defaultKeywords, context) {
        const keywords = [...new Set([...(context?.keywords || []), ...defaultKeywords])];
        const contextRecord = {};
        if (context?.businessName)
            contextRecord.businessName = context.businessName;
        const matched = (0, openwa_plugins_service_1.selectPlugins)(keywords, contextRecord, 3);
        return (0, openwa_plugins_service_1.buildPluginSummary)(matched);
    }
}
exports.WhatsAppIntentService = WhatsAppIntentService;
exports.whatsAppIntentService = new WhatsAppIntentService();
//# sourceMappingURL=whatsapp-intent.service.js.map