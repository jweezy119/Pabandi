...
exports.initializePabEconomy = initializePabEconomy;
exports.getOrCreateWallet = getOrCreateWallet;
exports.getWallet = getWallet;
exports.earnPab = earnPab;
exports.spendPab = spendPab;
exports.stakePab = stakePab;
exports.unstakePab = unstakePab;
exports.recordPlatformFee = recordPlatformFee;
exports.getTreasury = getTreasury;
exports.getPabStats = getPabStats;
...
async function initializePabEconomy() {
    // Seed earn rules
...
// ── Earn ────────────────────────────────────────────────────────────────────
async function earnPab(userId, action, refType, refId) {
...
// ── Spend ───────────────────────────────────────────────────────────────────
async function spendPab(userId, action, refType, refId) {
...
// ── Unstake ─────────────────────────────────────────────────────────────────
async function unstakePab(userId) {
    const wallet = await prisma.pabWallet.findUnique({ where: { userId } });
    if (!wallet || wallet.stakedAmt === 0)
        throw new Error('No staked PAB');
...
// ── Treasury ────────────────────────────────────────────────────────────────
async function recordPlatformFee(solAmount) {
...
//# sourceMappingURL=pabEconomy.service.js.map