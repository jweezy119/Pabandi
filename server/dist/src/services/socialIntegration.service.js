...
exports.socialIntegrationService = void 0;
...
exports.socialIntegrationService = {
    ...
    // ═══════════════════════════════════════════════════════════════════════════
    async connectSocialAccount(userId, platform, data) {
    ...
    // ═══════════════════════════════════════════════════════════════════════════
    async shareToSocial(userId, platform, content) {
    ...
    // ═══════════════════════════════════════════════════════════════════════════
    async getOAuthUrl(platform, redirectUri) {
        const oauthUrls = {
    ...
    async handleOAuthCallback(platform, code, redirectUri) {
    ...
    // ═══════════════════════════════════════════════════════════════════════════
    async generateDeepLink(type, id) {
    ...
    async generateSocialEntryQR(venueId, eventId) {
        const baseUrl = 'https://pabandi.com';
...
//# sourceMappingURL=socialIntegration.service.js.map