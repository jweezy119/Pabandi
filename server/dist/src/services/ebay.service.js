...
exports.ebayService = exports.EbayService = void 0;
...
class EbayService {
     ...
     */
    async fetchActiveListings(accessToken) {
        logger_1.logger.info(`[EbayService] Fetching eBay inventory using token: ${accessToken.substring(0, 10)}...`);
...
exports.ebayService = new EbayService();
