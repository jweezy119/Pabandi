...
export declare function calculateClientScore(_clientId: string, jobs: any[]): number;
export declare function getClientStage(client: any, jobs: any[]): string;
export declare function updateClientScore(_clientId: string): void;
export declare function refreshClientTrust(clientId: string): {
    stage: string;
    score: number;
};
