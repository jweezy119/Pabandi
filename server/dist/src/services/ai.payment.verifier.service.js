...
exports.aiPaymentVerifierService = exports.AiPaymentVerifierService = void 0;
const axios_1 = __importDefault(require("axios"));
const DASHSCOPE_API_KEY = process.env.DASHSCOPE_API_KEY || '';
const DASHSCOPE_VISION_URL = 'https://dashscope.aliyuncs.com/api/v1/services/aigc/multimodal-generation/generation';
class AiPaymentVerifierService {
    async verify(imageBase64, expectedAmountPkr, expectedDestination) {
...
`.trim();
        ...
        try {
            const response = await axios_1.default.post(DASHSCOPE_VISION_URL, payload, {
                headers: {
    ...
    evaluate(fields, expectedAmountPkr, expectedDestination, raw) {
    ...
    localFallback(expectedAmountPkr, expectedDestination) {
        return {
            isValid: false,
            confidence: 0,
            fields: {
...
exports.AiPaymentVerifierService = AiPaymentVerifierService;
exports.aiPaymentVerifierService = new AiPaymentVerifierService();
//# sourceMappingURL=ai.payment.verifier.service.js.map