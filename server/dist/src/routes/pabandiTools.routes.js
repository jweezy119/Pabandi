...
router.get('/tools', async (_req, res) => {
    try {
        const doc = (0, pabandiTools_service_1.pabandiPlatformDoc)();
...
router.get('/.well-known/pabandi/tools.json', (_req, res) => {
    try {
        const doc = (0, pabandiTools_service_1.pabandiPlatformDoc)();
...
router.get('/spec', (_req, res) => {
    try {
        ...
        const spec = {
            ...
            tags: [...new Set(doc.tools.map((t) => t.category).concat(['trust', 'sdk']))],
            paths,
            components: {
                schemas: {
                    PabandiTool: {
...
//# sourceMappingURL=pabandiTools.routes.js.map