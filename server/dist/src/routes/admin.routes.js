...
router.post('/setup', admin_controller_1.setupAdmin);
...
router.delete('/businesses/:id', admin_controller_1.softDeleteBusiness);
router.patch('/businesses/:id', admin_controller_1.updateBusiness);
...
router.get('/tenants', admin_controller_1.getAllTenants);
router.get('/leases', admin_controller_1.getAllLeases);
