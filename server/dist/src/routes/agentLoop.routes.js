...
router.post('/prepare-live', auth_middleware_1.authenticate, (0, auth_middleware_1.authorize)('ADMIN'), async (req, res) => {
...
router.post('/run-once', auth_middleware_1.authenticate, (0, auth_middleware_1.authorize)('ADMIN'), async (_req, res) => {
    try {
...
router.post('/start', auth_middleware_1.authenticate, (0, auth_middleware_1.authorize)('ADMIN'), (_req, res) => { (0, agentLoop_service_1.startAgentLoop)(); res.json({ success: true, data: (0, agentLoop_service_1.getAgentLoopState)() }); });
router.post('/stop', auth_middleware_1.authenticate, (0, auth_middleware_1.authorize)('ADMIN'), (_req, res) => { (0, agentLoop_service_1.stopAgentLoop)(); res.json({ success: true, data: (0, agentLoop_service_1.getAgentLoopState)() }); });
