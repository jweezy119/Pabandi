...
router.post('/session/:id/cashapp', auth_middleware_1.optionalAuthenticate, checkout_controller_1.initiateCashAppCheckout);
...
router.post('/session/:id/paylio', auth_middleware_1.optionalAuthenticate, checkout_controller_1.initiatePayLioCheckout);
router.get('/session/:id/paylio/callback', checkout_controller_1.paylioCallback);
// On-ramp quotes and sessions (fiat -> crypto)
router.get('/onramp/quotes', checkout_controller_1.getOnrampQuotes);
router.post('/onramp/session', checkout_controller_1.createOnrampSession);
